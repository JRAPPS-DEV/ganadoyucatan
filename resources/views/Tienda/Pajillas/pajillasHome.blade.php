...
@section('content')
<head>
	<title>Pajillas de semen bovino - Ganado Yucatán</title>
</head>
...
<script src="{{url('/static/js/location.js') }}" ></script>
	...
	<div class="tienda-section">
		<div class="banner-main-pajillas">
			<img class="icon-banner" src="{{ asset('static/new/Iconos/tianguis.png') }}" alt="">
			<h1>Pajillas de semen bovino</h1>
			<p>Pajillas de Semen Bovino de alta genética- Mejora Genética Garantizada para tu Rebaño</p>
		</div>
		<div class="container-tienda">
			<div class="filtro-container">
                <div class="filtro-container-info">
                    <h2>Filtro</h2>
                    <hr>
                    <form class="tianguis-form" action="{{ route('getPajillasTienda') }}" method="GET">
                        <div class="filtro-container-down">
                            ...
                            <div class="card">
                                ...
                                <div class="price-content">
                                    <div>
                                        <label>Min</label>
                                        <p id="min-value">$400</p> {{-- TODO cambiar el valor de minimo --}}
                                    </div>
                                    <div>
                                        <label>Max</label>
                                        <p id="max-value">$3000</p> {{-- TODO cambiar el valor de maximo --}}
                                    </div>
                                </div>
                                <div class="range-slider">
                                    <div class="range-fill"></div>
                                    <input type="range" class="min-price" name="minPrecio" value="1000" min="400" max="3000" step="100" />
                                    <input type="range" class="max-price" name="maxPrecio" value="2500" min="400" max="3000" step="100" />
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    function actualizarFiltros() {
        ...
        window.location.href = '/pajillas?' + queryEstado + queryCiudad + queryTipo + queryMin + queryMax; //+  +  '&min_price=' + minPrice + '&max_price=' + maxPrice;
    }
});
